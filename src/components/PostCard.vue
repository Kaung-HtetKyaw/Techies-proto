      ...
      <v-card-title class="py-0 px-0">
        <v-slide-group multiple show-arrows>
          <v-slide-item
            ...
            :key="tag"
          >
            <v-chip class="ma-2" outlined :input-value="active" @click="toggle"
              >#{{ tag }}</v-chip
            >
          </v-slide-item>
        </v-slide-group>
          ...
          <v-row dense class="d-flex flex-column-reverse flex-md-row">
            <v-col cols="12" sm="12" md="9" class="my-1">
              <router-link
                ...
                class="router-link"
              >
                <h2 class="title font-weight-medium black--text mb-4 serif">
                  {{ post.title }}
                </h2>
                <h3 class="subtitle-1 black--text mt-2 opacity7">
          ...
          <v-row dense class="d-flex">
            ...
            >
              <div class="pr-2">
                ...
                <span v-if="post.likes.length > 0" class="subheading mr-2">{{
                  post.likes.length
                }}</span>
              </div>
              ...
              <div v-if="post.uid === user.uid" class="pr-2">
                <router-link
                  :to="{ name: 'edit', params: { id: post.postid } }"
                  class="router-link"
                >
