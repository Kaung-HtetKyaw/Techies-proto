  ...
  <div class="my-6">
    <v-card class="mx-auto" elevation="0" color="#fff py-0">
      <v-card-title class="py-0 px-0">
        <h5 class="headline">Popular on Techies</h5>
      </v-card-title>
        ...
        <v-container fluid>
          ...
          >
            <v-col cols="12" sm="3" class="my-1">
              <p class="display-1 opacity9">0{{ index + 1 }}</p>
            </v-col>
            <v-col cols="12" sm="9">
              <h5 class="title font-weight-medium black--text">
                {{ post.title }}
              </h5>
              <h5 class="body-2 black--text font-weight-light py-2">
                {{ post.author.displayName }}
              </h5>
              <div class="caption">
                <span class="px-1">{{ post.date }}</span>
                <span>|</span>
                <span class="px-1">{{ post.readTime }} read</span>
              </div>
            </v-col>
          </v-row>
        </v-container>
